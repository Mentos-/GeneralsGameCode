...
public:
	...
	// Union
	RectClass & operator += ( const RectClass & r ) { Left=GENERALS_MIN(Left,r.Left); Top=GENERALS_MIN(Top,r.Top); Right=GENERALS_MAX(Right,r.Right); Bottom=GENERALS_MAX(Bottom,r.Bottom); return *this; }
