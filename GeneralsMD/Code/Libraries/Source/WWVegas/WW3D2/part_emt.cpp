	...
	IsInvisible(false)
{
	...
	if (max_particles > 0) max_num = GENERALS_MIN(max_num, max_particles);
	if (max_buffer_size > 0) max_num = GENERALS_MIN(max_num, max_buffer_size);
	max_num = GENERALS_MAX(max_num, 2);	// max_num of 1 causes problems
