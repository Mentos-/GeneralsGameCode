...
//-----------------------------------------------------------------------------
inline void GadgetProgressBarSetEnabledColor( GameWindow *g, GeneralsColor color )								{ g->winSetEnabledColor( 0, color ); }
inline void GadgetProgressBarSetEnabledBorderColor( GameWindow *g, GeneralsColor color )					{ g->winSetEnabledBorderColor( 0, color ); }
...
inline void GadgetProgressBarSetEnabledBarColor( GameWindow *g, GeneralsColor color )							{ g->winSetEnabledColor( 4, color ); }
inline void GadgetProgressBarSetEnabledBarBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetEnabledBorderColor( 4, color ); }
...
inline GeneralsColor   GadgetProgressBarGetEnabledColor( GameWindow *g )								{ return g->winGetEnabledColor( 0 ); }
inline GeneralsColor   GadgetProgressBarGetEnabledBorderColor( GameWindow *g )					{ return g->winGetEnabledBorderColor( 0 ); }
...
inline GeneralsColor   GadgetProgressBarGetEnabledBarColor( GameWindow *g )							{ return g->winGetEnabledColor( 4 ); }
inline GeneralsColor   GadgetProgressBarGetEnabledBarBorderColor( GameWindow *g )				{ return g->winGetEnabledBorderColor( 4 ); }
...
//-----------------------------------------------------------------------------
inline void GadgetProgressBarSetDisabledColor( GameWindow *g, GeneralsColor color )									{ g->winSetDisabledColor( 0, color ); }
inline void GadgetProgressBarSetDisabledBorderColor( GameWindow *g, GeneralsColor color )						{ g->winSetDisabledBorderColor( 0, color ); }
...
inline void GadgetProgressBarSetDisabledBarColor( GameWindow *g, GeneralsColor color )							{ g->winSetDisabledColor( 4, color ); }
inline void GadgetProgressBarSetDisabledBarBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetDisabledBorderColor( 4, color ); }
...
inline GeneralsColor   GadgetProgressBarGetDisabledColor( GameWindow *g )								{ return g->winGetDisabledColor( 0 ); }
inline GeneralsColor   GadgetProgressBarGetDisabledBorderColor( GameWindow *g )					{ return g->winGetDisabledBorderColor( 0 ); }
...
inline GeneralsColor   GadgetProgressBarGetDisabledBarColor( GameWindow *g )						{ return g->winGetDisabledColor( 4 ); }
inline GeneralsColor   GadgetProgressBarGetDisabledBarBorderColor( GameWindow *g )			{ return g->winGetDisabledBorderColor( 4 ); }
...
//-----------------------------------------------------------------------------
inline void GadgetProgressBarSetHiliteColor( GameWindow *g, GeneralsColor color )									{ g->winSetHiliteColor( 0, color ); }
inline void GadgetProgressBarSetHiliteBorderColor( GameWindow *g, GeneralsColor color )						{ g->winSetHiliteBorderColor( 0, color ); }
...
inline void GadgetProgressBarSetHiliteBarColor( GameWindow *g, GeneralsColor color )							{ g->winSetHiliteColor( 4, color ); }
inline void GadgetProgressBarSetHiliteBarBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetHiliteBorderColor( 4, color ); }
...
inline GeneralsColor   GadgetProgressBarGetHiliteColor( GameWindow *g )								{ return g->winGetHiliteColor( 0 ); }
inline GeneralsColor   GadgetProgressBarGetHiliteBorderColor( GameWindow *g )					{ return g->winGetHiliteBorderColor( 0 ); }
...
inline GeneralsColor   GadgetProgressBarGetHiliteBarColor( GameWindow *g )						{ return g->winGetHiliteColor( 4 ); }
inline GeneralsColor   GadgetProgressBarGetHiliteBarBorderColor( GameWindow *g )			{ return g->winGetHiliteBorderColor( 4 ); }
