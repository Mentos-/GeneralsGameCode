...
inline void GadgetTextEntrySetTextColor( GameWindow *g, GeneralsColor color )
{
	GeneralsColor back = g->winGetEnabledTextBorderColor();
...
inline void GadgetTextEntrySetEnabledColor( GameWindow *g, GeneralsColor color )				{ g->winSetEnabledColor( 0, color ); }
inline void GadgetTextEntrySetEnabledBorderColor( GameWindow *g, GeneralsColor color )	{ g->winSetEnabledBorderColor( 0, color ); }
...
inline GeneralsColor GadgetTextEntryGetEnabledColor( GameWindow *g )							{ return g->winGetEnabledColor( 0 ); }
inline GeneralsColor GadgetTextEntryGetEnabledBorderColor( GameWindow *g )				{ return g->winGetEnabledBorderColor( 0 ); }
...
inline void GadgetTextEntrySetDisabledColor( GameWindow *g, GeneralsColor color )				{ g->winSetDisabledColor( 0, color ); }
inline void GadgetTextEntrySetDisabledBorderColor( GameWindow *g, GeneralsColor color )	{ g->winSetDisabledBorderColor( 0, color ); }
...
inline GeneralsColor GadgetTextEntryGetDisabledColor( GameWindow *g )								{ return g->winGetDisabledColor( 0 ); }
inline GeneralsColor GadgetTextEntryGetDisabledBorderColor( GameWindow *g )					{ return g->winGetDisabledBorderColor( 0 ); }
...
inline void GadgetTextEntrySetHiliteColor( GameWindow *g, GeneralsColor color )					{ g->winSetHiliteColor( 0, color ); }
inline void GadgetTextEntrySetHiliteBorderColor( GameWindow *g, GeneralsColor color )		{ g->winSetHiliteBorderColor( 0, color ); }
...
inline GeneralsColor GadgetTextEntryGetHiliteColor( GameWindow *g )								{ return g->winGetHiliteColor( 0 ); }
inline GeneralsColor GadgetTextEntryGetHiliteBorderColor( GameWindow *g )					{ return g->winGetHiliteBorderColor( 0 ); }
