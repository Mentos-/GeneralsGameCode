...
extern UnicodeString GadgetListBoxGetTextAndColor( GameWindow *listbox, GeneralsColor *color, Int row, Int column = 0);
extern Int GadgetListBoxAddEntryText( GameWindow *listbox,	UnicodeString text,	GeneralsColor color, Int row, Int column = -1, Bool overwrite = TRUE);
extern Int GadgetListBoxAddEntryImage( GameWindow *listbox, const Image *image,
																			Int row, Int column = -1,
																			Bool overwrite = TRUE, GeneralsColor color = 0xFFFFFFFF );
extern Int GadgetListBoxAddEntryImage( GameWindow *listbox, const Image *image,
																			Int row, Int column,
																			Int hight, Int width,
																			Bool overwrite = TRUE, GeneralsColor color = 0xFFFFFFFF );
...
inline void GadgetListBoxSetEnabledColor( GameWindow *g, GeneralsColor color )													{ g->winSetEnabledColor( 0, color ); }
inline void GadgetListBoxSetEnabledBorderColor( GameWindow *g, GeneralsColor color )										{ g->winSetEnabledBorderColor( 0, color ); }
...
inline void GadgetListBoxSetEnabledSelectedItemColor( GameWindow *g, GeneralsColor color )							{ g->winSetEnabledColor( 1, color ); }
inline void GadgetListBoxSetEnabledSelectedItemBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetEnabledBorderColor( 1, color ); }
inline const Image *GadgetListBoxGetEnabledImage( GameWindow *g )												{ return g->winGetEnabledImage( 0 ); }
inline GeneralsColor  GadgetListBoxGetEnabledColor( GameWindow *g )												{ return g->winGetEnabledColor( 0 ); }
inline GeneralsColor  GadgetListBoxGetEnabledBorderColor( GameWindow *g )									{ return g->winGetEnabledBorderColor( 0 ); }
...
inline GeneralsColor	GadgetListBoxGetEnabledSelectedItemColor( GameWindow *g )						{ return g->winGetEnabledColor( 1 ); }
inline GeneralsColor	GadgetListBoxGetEnabledSelectedItemBorderColor( GameWindow *g )			{ return g->winGetEnabledBorderColor( 1 ); }

inline void GadgetListBoxSetDisabledImage( GameWindow *g, const Image *image )												{ g->winSetDisabledImage( 0, image ); }
inline void GadgetListBoxSetDisabledColor( GameWindow *g, GeneralsColor color )													{ g->winSetDisabledColor( 0, color ); }
inline void GadgetListBoxSetDisabledBorderColor( GameWindow *g, GeneralsColor color )										{ g->winSetDisabledBorderColor( 0, color ); }
...
inline void GadgetListBoxSetDisabledSelectedItemColor( GameWindow *g, GeneralsColor color )							{ g->winSetDisabledColor( 1, color ); }
inline void GadgetListBoxSetDisabledSelectedItemBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetDisabledBorderColor( 1, color ); }
inline const Image *GadgetListBoxGetDisabledImage( GameWindow *g )												{ return g->winGetDisabledImage( 0 ); }
inline GeneralsColor	GadgetListBoxGetDisabledColor( GameWindow *g )												{ return g->winGetDisabledColor( 0 ); }
inline GeneralsColor	GadgetListBoxGetDisabledBorderColor( GameWindow *g )									{ return g->winGetDisabledBorderColor( 0 ); }
...
inline GeneralsColor	GadgetListBoxGetDisabledSelectedItemColor( GameWindow *g )						{ return g->winGetDisabledColor( 1 ); }
inline GeneralsColor	GadgetListBoxGetDisabledSelectedItemBorderColor( GameWindow *g )			{ return g->winGetDisabledBorderColor( 1 ); }

inline void GadgetListBoxSetHiliteImage( GameWindow *g, const Image *image )												{ g->winSetHiliteImage( 0, image ); }
inline void GadgetListBoxSetHiliteColor( GameWindow *g, GeneralsColor color )													{ g->winSetHiliteColor( 0, color ); }
inline void GadgetListBoxSetHiliteBorderColor( GameWindow *g, GeneralsColor color )										{ g->winSetHiliteBorderColor( 0, color ); }
...
inline void GadgetListBoxSetHiliteSelectedItemColor( GameWindow *g, GeneralsColor color )							{ g->winSetHiliteColor( 1, color ); }
inline void GadgetListBoxSetHiliteSelectedItemBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetHiliteBorderColor( 1, color ); }
inline const Image *GadgetListBoxGetHiliteImage( GameWindow *g )												{ return g->winGetHiliteImage( 0 ); }
inline GeneralsColor	GadgetListBoxGetHiliteColor( GameWindow *g )												{ return g->winGetHiliteColor( 0 ); }
inline GeneralsColor	GadgetListBoxGetHiliteBorderColor( GameWindow *g )									{ return g->winGetHiliteBorderColor( 0 ); }
...
inline GeneralsColor	GadgetListBoxGetHiliteSelectedItemColor( GameWindow *g )						{ return g->winGetHiliteColor( 1 ); }
inline GeneralsColor	GadgetListBoxGetHiliteSelectedItemBorderColor( GameWindow *g )			{ return g->winGetHiliteBorderColor( 1 ); }
