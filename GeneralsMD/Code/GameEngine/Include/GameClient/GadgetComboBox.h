...
extern Int  GadgetComboBoxAddEntry( GameWindow *comboBox, UnicodeString text, GeneralsColor color );
...
extern void GadgetComboBoxSetEnabledTextColors( GameWindow *comboBox, GeneralsColor color, GeneralsColor borderColor );
extern void GadgetComboBoxSetDisabledTextColors( GameWindow *comboBox, GeneralsColor color, GeneralsColor borderColor );
extern void GadgetComboBoxSetHiliteTextColors( GameWindow *comboBox, GeneralsColor color, GeneralsColor borderColor );
extern void GadgetComboBoxSetIMECompositeTextColors( GameWindow *comboBox, GeneralsColor color, GeneralsColor borderColor );
...
inline void GadgetComboBoxSetEnabledColor( GameWindow *g, GeneralsColor color )													{ g->winSetEnabledColor( 0, color ); }
inline void GadgetComboBoxSetEnabledBorderColor( GameWindow *g, GeneralsColor color )										{ g->winSetEnabledBorderColor( 0, color ); }
...
inline void GadgetComboBoxSetEnabledSelectedItemColor( GameWindow *g, GeneralsColor color )							{ g->winSetEnabledColor( 1, color ); }
inline void GadgetComboBoxSetEnabledSelectedItemBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetEnabledBorderColor( 1, color ); }
inline const Image *GadgetComboBoxGetEnabledImage( GameWindow *g )												{ return g->winGetEnabledImage( 0 ); }
inline GeneralsColor  GadgetComboBoxGetEnabledColor( GameWindow *g )												{ return g->winGetEnabledColor( 0 ); }
inline GeneralsColor  GadgetComboBoxGetEnabledBorderColor( GameWindow *g )									{ return g->winGetEnabledBorderColor( 0 ); }
...
inline GeneralsColor	GadgetComboBoxGetEnabledSelectedItemColor( GameWindow *g )						{ return g->winGetEnabledColor( 1 ); }
inline GeneralsColor	GadgetComboBoxGetEnabledSelectedItemBorderColor( GameWindow *g )			{ return g->winGetEnabledBorderColor( 1 ); }

inline void GadgetComboBoxSetDisabledImage( GameWindow *g, const Image *image )												{ g->winSetDisabledImage( 0, image ); }
inline void GadgetComboBoxSetDisabledColor( GameWindow *g, GeneralsColor color )													{ g->winSetDisabledColor( 0, color ); }
inline void GadgetComboBoxSetDisabledBorderColor( GameWindow *g, GeneralsColor color )										{ g->winSetDisabledBorderColor( 0, color ); }
...
inline void GadgetComboBoxSetDisabledSelectedItemColor( GameWindow *g, GeneralsColor color )							{ g->winSetDisabledColor( 1, color ); }
inline void GadgetComboBoxSetDisabledSelectedItemBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetDisabledBorderColor( 1, color ); }
inline const Image *GadgetComboBoxGetDisabledImage( GameWindow *g )												{ return g->winGetDisabledImage( 0 ); }
inline GeneralsColor	GadgetComboBoxGetDisabledColor( GameWindow *g )												{ return g->winGetDisabledColor( 0 ); }
inline GeneralsColor	GadgetComboBoxGetDisabledBorderColor( GameWindow *g )									{ return g->winGetDisabledBorderColor( 0 ); }
...
inline GeneralsColor	GadgetComboBoxGetDisabledSelectedItemColor( GameWindow *g )						{ return g->winGetDisabledColor( 1 ); }
inline GeneralsColor	GadgetComboBoxGetDisabledSelectedItemBorderColor( GameWindow *g )			{ return g->winGetDisabledBorderColor( 1 ); }

inline void GadgetComboBoxSetHiliteImage( GameWindow *g, const Image *image )												{ g->winSetHiliteImage( 0, image ); }
inline void GadgetComboBoxSetHiliteColor( GameWindow *g, GeneralsColor color )													{ g->winSetHiliteColor( 0, color ); }
inline void GadgetComboBoxSetHiliteBorderColor( GameWindow *g, GeneralsColor color )										{ g->winSetHiliteBorderColor( 0, color ); }
...
inline void GadgetComboBoxSetHiliteSelectedItemColor( GameWindow *g, GeneralsColor color )							{ g->winSetHiliteColor( 1, color ); }
inline void GadgetComboBoxSetHiliteSelectedItemBorderColor( GameWindow *g, GeneralsColor color )				{ g->winSetHiliteBorderColor( 1, color ); }
inline const Image *GadgetComboBoxGetHiliteImage( GameWindow *g )												{ return g->winGetHiliteImage( 0 ); }
inline GeneralsColor	GadgetComboBoxGetHiliteColor( GameWindow *g )												{ return g->winGetHiliteColor( 0 ); }
inline GeneralsColor	GadgetComboBoxGetHiliteBorderColor( GameWindow *g )									{ return g->winGetHiliteBorderColor( 0 ); }
...
inline GeneralsColor	GadgetComboBoxGetHiliteSelectedItemColor( GameWindow *g )						{ return g->winGetHiliteColor( 1 ); }
inline GeneralsColor	GadgetComboBoxGetHiliteSelectedItemBorderColor( GameWindow *g )			{ return g->winGetHiliteBorderColor( 1 ); }
