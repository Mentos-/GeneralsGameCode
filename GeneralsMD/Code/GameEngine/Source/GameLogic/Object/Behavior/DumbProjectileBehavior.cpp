...
Bool DumbProjectileBehavior::calcFlightPath(Bool recalcNumSegments)
{
	...
	highestInterveningTerrain = generals_max( highestInterveningTerrain, controlPoints[0].z );
	highestInterveningTerrain = generals_max( highestInterveningTerrain, controlPoints[3].z );
