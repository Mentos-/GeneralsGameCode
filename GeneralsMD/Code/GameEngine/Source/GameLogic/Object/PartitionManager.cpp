...
void PartitionCell::addLooker(Int playerIndex)
{
	...
	m_shroudLevel[playerIndex].m_currentShroud = generals_min( m_shroudLevel[playerIndex].m_currentShroud - 1, -1 );
...
void PartitionCell::removeLooker(Int playerIndex)
{
	...
	if( m_shroudLevel[playerIndex].m_currentShroud == -1 )
		m_shroudLevel[playerIndex].m_currentShroud = generals_min( m_shroudLevel[playerIndex].m_activeShroudLevel, (Short)1 );
	else
	{
