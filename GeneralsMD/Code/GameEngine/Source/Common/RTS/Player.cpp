...
Bool Player::addSkillPoints(Int delta)
{
	...
	Int levelCap = generals_min( TheGameLogic->getRankLevelLimit(), TheRankInfoStore->getRankLevelCount() );
	...
	m_skillPoints = generals_min( pointCap, (m_skillPoints + delta) );
...
void Player::applyBattlePlanBonusesForPlayerObjects( const BattlePlanBonuses *bonus )
{
	...
	else
	{
		...
		m_battlePlanBonuses->m_bombardment					=	 GENERALS_MAX( 0, m_battlePlanBonuses->m_bombardment );
		m_battlePlanBonuses->m_holdTheLine					+= bonus->m_holdTheLine;
		m_battlePlanBonuses->m_holdTheLine					=	 GENERALS_MAX( 0, m_battlePlanBonuses->m_holdTheLine );
		m_battlePlanBonuses->m_searchAndDestroy			+= bonus->m_searchAndDestroy;
		m_battlePlanBonuses->m_searchAndDestroy			=	 GENERALS_MAX( 0, m_battlePlanBonuses->m_searchAndDestroy );
	}
