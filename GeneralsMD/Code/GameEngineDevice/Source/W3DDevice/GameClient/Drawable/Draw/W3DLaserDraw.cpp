...
//				lineEnd.z = lineStart.z;
				...
				laserPoints[ 0 ].Set( segmentStart.x, segmentStart.y, 
					GENERALS_MAX( segmentStart.z, 2.0f + TheTerrainLogic->getGroundHeight(segmentStart.x, segmentStart.y) ) );
				laserPoints[ 1 ].Set( segmentEnd.x, segmentEnd.y, 
					GENERALS_MAX( segmentEnd.z, 2.0f + TheTerrainLogic->getGroundHeight(segmentEnd.x, segmentEnd.y) ) );
